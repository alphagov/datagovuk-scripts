...
- Value set as `govuk-ckan-output-<test|integration|staging|production>`
...
CKAN_OUTPUT_BUCKET_NAME=govuk-ckan-output-test
```
...
```bash
aws --endpoint-url=http://localhost:4566 s3 mb s3://govuk-ckan-output-test
```
