...
This repository contains one-off scripts and report CSV files relating to efforts
...
The repo also holds CSV files relating to link checking activity.
`reports/check-links-output/` contains outputs from our check links scripts in 
https://github.com/alphagov/ckanext-datagovuk
`reports/retry/` contains outputs from our retry scripts in this repository.
